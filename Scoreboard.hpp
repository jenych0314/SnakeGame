...
public:
    ...
    void updateScore(s_score gameScore) // 수정
    {
        ...
        mvwprintw(score_win, 6, 1, "Score Board");
        mvwprintw(score_win, 7, 1, "Current Length/Max Length : %d / %d", gameScore.cur_len, gameScore.max_len);
        mvwprintw(score_win, 8, 1, "Eat Apple Count : %d ", gameScore.apple_score);
        mvwprintw(score_win, 9, 1, "Eat Poison Count : %d ", gameScore.poison_score);
